...
6. [lib/features/auth/data/datasources/dio_auth_remote_data_source.dart](/Users/jerry/dev/flutter_project/riverpod3_starter/lib/features/auth/data/datasources/dio_auth_remote_data_source.dart)
...
8. [lib/features/products/data/datasources/dio_products_remote_data_source.dart](/Users/jerry/dev/flutter_project/riverpod3_starter/lib/features/products/data/datasources/dio_products_remote_data_source.dart)
...
12. [lib/features/posts/data/datasources/dio_posts_remote_data_source.dart](/Users/jerry/dev/flutter_project/riverpod3_starter/lib/features/posts/data/datasources/dio_posts_remote_data_source.dart)
...
- `core/`
  여러 feature가 같이 쓰는 공통 코드입니다. `error`, `network`, `storage`, 공통 위젯이 있습니다.
- `features/`
...
- `build()`에서 repository를 호출해 첫 목록을 가져옵니다.
...
- 파일:
  [lib/features/auth/data/datasources/dio_auth_remote_data_source.dart](/Users/jerry/dev/flutter_project/riverpod3_starter/lib/features/auth/data/datasources/dio_auth_remote_data_source.dart)
  [lib/features/products/data/datasources/dio_products_remote_data_source.dart](/Users/jerry/dev/flutter_project/riverpod3_starter/lib/features/products/data/datasources/dio_products_remote_data_source.dart)
  [lib/features/posts/data/datasources/dio_posts_remote_data_source.dart](/Users/jerry/dev/flutter_project/riverpod3_starter/lib/features/posts/data/datasources/dio_posts_remote_data_source.dart)
